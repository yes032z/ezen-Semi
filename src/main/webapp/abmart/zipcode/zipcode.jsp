...
<script type="text/javascript">
	...
	function setZipcode(zipcode, address){
		$(opener.document).find('#zipno').val(zipcode); /* 회원가입창 아이디가 zipcode인곳에 값 뿌리기 */
		$(opener.document).find('input[name = detailaddress]').val(address); /* 회원가입창 name = address인 부분에 뿌리기 */
