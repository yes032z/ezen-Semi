...
<html lang="en">
    ...
    <!-- 한글 인코딩이 깨져서 영어로 표시  -->
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><hr class="dropdown-divider" />Products Name</li>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">Cart in</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"> AB-MART &copy; SemiProject 4 </p></div>
        </footer>
        <!-- Bootstrap core JS-->
