...
<body>
		...
		<div class="container px-4 px-lg-5">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<input class="form-control mr-sm-2" type="search"
					placeholder="검색어를 입력해주세요" aria-label="Search" style="width: 600px;">
 ...
 <div id="carouselExample" class="carousel slide">
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">AB-MART &copy; SemiProject
				4</p>
			<br>
			<div>
				<span class="m-0 text-center text-white">고객센터</span> <span
					class="m-0 text-center text-white">1521-1521</span> <span
					class="m-0 text-center text-white">월~금 09:00 ~ 12:00 / 13:00
					~ 18:00(주말,공휴일 휴무)</span>
			</div>
			<div>
				<span class="m-0 text-center text-white">(주)에이비마트 | 대표이사 :
					송영은 | 주소: 서울 서초구 서초대로77길 55 에이프로스퀘어 3층</span><br> <span
					class="m-0 text-center text-white">사업자등록번호 : 123-45-67890 |
					통신판매업신고:제 2023-서울서초구-1000호</span><br> <span
					class="m-0 text-center text-white">개인정보보호 책임자:최곽두 |
					이메일:abmart@abmart.com</span>
			</div>
		</div>
	</footer>
	<!-- Bootstrap core JS-->
